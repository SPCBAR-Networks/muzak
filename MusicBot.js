...
client.on('ready', () => console.log('Ready to go fuckwit'));
client.on('disconnect', () => console.log('I just disconnected, making sure you know, I will reconnect now...'));
client.on('guildMemberAdd', (member) => {
	member.addRole('645461514236723201').catch(e => {
			console.error(e);
		});
	console.log('Added \'shadow realm\' role to new member')
});
...
Please provide a value to select one of the search results ranging from 1-5.
		...
		msg.channel.send("-play https://youtube.com/watch?v=Mqvc00qu-3Y&t=1s")
